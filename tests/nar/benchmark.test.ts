import {atom, RuleProcessor, Stamp, TermBuilder, termsEqual, Truth} from '../../src/nar';
...
describe('Performance benchmarks', () => {
    ...
    test('rule dispatch benchmark (Jest-overhead adjusted)', () => {
        ...
        const t1 = {term: TermBuilder.inheritance(atom('A'), atom('B')), truth: Truth.TRUE, stamp: Stamp.createInput()};
        const t2 = {term: TermBuilder.inheritance(atom('B'), atom('C')), truth: Truth.TRUE, stamp: Stamp.createInput()};
