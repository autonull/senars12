    ...
    try {
      ...
      for (const [rawPath, coverage] of Object.entries(coverageDetail)) {
        try {
          ...
          const lineCoverage =
            statementCount > 0 ? (coveredStatements / statementCount) * 100 : 100;
          ...
          files.push({
            ...
            lineCoverage: Number.parseFloat(lineCoverage.toFixed(2)),
          ...
          if (verbose) {
            Logger.warn(`Error processing coverage for ${filePath}:`, {
