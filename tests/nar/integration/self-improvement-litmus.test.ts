...
import { registerMetaRules, META_REASONING_BELIEFS, initializeMetaReasoning } from '../../../nar/src/rules/meta-rules.js';
...
async function runTestsInWorkspace(workspace: string): Promise<{ success: boolean; passed: number; failed: number; total: number }> {
