...
export class Module {
  ...
  parameters() {
    return [
      ...
      ...Array.from(this._modules.values()).flatMap((m) => m.parameters()),
    ];
  }
...
export class MultiHeadAttention extends Module {
  constructor(dModel, numHeads, { backend = T } = {}) {
    ...
    ['qProj', 'kProj', 'vProj', 'outProj'].forEach(
      (name) => (this[name] = this.module(name, new Linear(dModel, dModel, { backend })))
    );
  }
