...
const patterns = [
  ...
  },
  {
    ...
    message:
      "Verbose 'termFactory.create({...})' found. Use specific methods like atomic(), inheritance(), etc.",
  },
  {
    regex: /termFactory\.create\(['"`][^'"`]+['"`]\)/g,
  ...
  },
  {
    regex: /termFactory\.create\(['"`](-->|<->|==>|<=>|&&|\|\||&\||\*|\/|\\|\^|==)['"`]/g,
    message:
      "Generic 'termFactory.create(op, ...)' found. Use specific methods like inheritance(), similarity(), etc.",
  },
];
