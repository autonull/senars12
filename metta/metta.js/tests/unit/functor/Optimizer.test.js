...
describe('Optimizers', () => {
  ...
  describe('SGDOptimizer', () => {
    test('updates parameters with learning rate', () => {
  ...
  describe('AdamOptimizer', () => {
    test('updates parameters with adaptive learning rate', () => {
    ...
    test('Adam handles different gradient magnitudes', () => {
      const optimizer = new AdamOptimizer(0.001);
  ...
  describe('RMSpropOptimizer', () => {
    test('updates parameters with RMSprop', () => {
    ...
    test('RMSprop accumulates squared gradients', () => {
  ...
  describe('Common Optimizer Behaviors', () => {
    const optimizers = [
    ...
    test.each(optimizers)('$name updates parameters', ({ factory }) => {
    ...
    test.each(optimizers)('$name handles missing gradients', ({ factory }) => {
      const optimizer = factory();
      const param = new Tensor([1, 2, 3], { requiresGrad: false, backend });
      const params = new Map([['w', param]]);
  ...
  describe('zeroGrad', () => {
    test('clears gradients for all parameters', () => {
      const optimizer = new SGDOptimizer(0.1);
      const param1 = new Tensor([1], { requiresGrad: true, backend });
  ...
  describe('training simulation', () => {
    test('SGD converges on simple linear problem', () => {
