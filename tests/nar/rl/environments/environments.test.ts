...
import { StochasticGridWorldEnv, NonStationaryBanditEnv, GridAction } from '../environments/RLEnvironments';
...
describe('Additional RL Environments', () => {
  describe('StochasticGridWorldEnv', () => {
    ...
    test('serialization works', () => {
      ...
      expect(env2.getEpisodeStepCount?.() ?? env2['stepCount']).toBe(env['stepCount']);
    });
  });
