...
export class Config {
  static parse(argv) {
    ...
    if (typeof process !== 'undefined' && process.env) {
      process.env.WS_PORT && (config.webSocket.port = Number.parseInt(process.env.WS_PORT));
      process.env.WS_HOST && (config.webSocket.host = process.env.WS_HOST);
      process.env.PORT && (config.ui.port = Number.parseInt(process.env.PORT));
    }
    ...
    const argHandlers = new Map([
      ...
      [
        '--temperature',
        (i) => {
          config.lm.temperature = Number.parseFloat(args[++i]);
          return i;
        },
      ],
      [
      ...
      [
        '--ws-port',
        (i) => {
          config.webSocket.port = Number.parseInt(args[++i]);
          return i;
        },
      ],
      [
      ...
      [
        '--port',
        (i) => {
          config.ui.port = Number.parseInt(args[++i]);
          return i;
        },
      ],
      [
