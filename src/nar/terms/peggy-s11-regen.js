...
function peg$parse(input, options) {
  ...
  function peg$f9() {    return options.termFactory.atomic('\\');  }
  function peg$f10() {    return options.termFactory.atomic('/');  }
  ...
  function peg$f16(op) {    return op.endsWith(',') ? op.slice(0, -1) : op;  }
  function peg$f17(op) {    return op;  }
