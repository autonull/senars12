...
export {trackTerm, untrackTerm, updateAccessTime, getTermMeta, structuralGC} from './lifecycle/gc.js';
export type {ForgettingPolicy, ForgettingConfig, ForgettingHooks} from './lifecycle/forgetting.js';
...
export type {SerializedMemory, SerializedConcept, SerializedTask, BagItemWithMeta} from './state/serialization.js';
