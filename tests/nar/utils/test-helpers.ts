 ...
 */
export function createTestTerm(symbol: string = 'test'): Term {
 ...
 */
export function createTestTruth(frequency: number = 0.5, confidence: number = 0.8): TruthType {
 ...
 */
export function createTestStamp(source: string = 'INPUT'): ReturnType<typeof Stamp.createInput> {
