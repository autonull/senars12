import type { Tool, ToolRegistry, ToolResult, Schema, ToolContext, ToolCapabilities, ToolChainStep, ToolChainResult, ToolFilter } from './types';
...
private validateResult(result: ToolResult, tool: Tool): ToolResult {
