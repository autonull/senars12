...
export type { LMContext, ValidationResult } from './types.js';
export type { LMRuleConfigV2 } from './types-v2.js';
...
export class LMRule {
  ...
  async apply(
    ...
    const systemOneMethod:
      | ((primary: Term, context?: Record<string, unknown>) => Promise<Task[]>)
      | null =
