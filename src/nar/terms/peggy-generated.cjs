...
function peg$parse(input, options) {
  ...
  const peg$e42 = peg$otherExpectation("atomic term");
  const peg$e43 = peg$classExpectation(["(", ")", "{", "}", "[", "]", "<", ">", ".", ",", "!", "%", "?", ";", ":", "@", " ", "\t", "\n", "\r", "=", "&", "/", "|", ">", "-"], true, false, false);
  const peg$e44 = peg$otherExpectation("hyphenated atom");
  ...
  function peg$f6(term) {    return options.termFactory.negation(term);  }
  function peg$f7(term) {    return options.termFactory.delta(term);  }
  function peg$f8(term) {    return options.termFactory.delta(term);  }
  function peg$f9() {    return options.termFactory.atom('\\');  }
  function peg$f10() {    return options.termFactory.atom('/');  }
  ...
  function peg$f14(subject, op, predicate) {
    const kindMap = {'-->': 'inheritance', '<->': 'similarity', '==>': 'implication', '<=>': 'equivalence', '<~>': 'contrast', '=/>' : 'predictive', '=|': 'retrospective', '=/=': 'anti', '=': 'equality', '&&': 'conjunction', '||': 'disjunction', '&|': 'parallel', '&/': 'sequence'};
  ...
  function peg$f18(components) {    return options.termFactory.create('setExt', components || []);  }
  function peg$f19(components) {    return options.termFactory.create('setInt', components || []);  }
  ...
  function peg$f21(chars) {    return options.termFactory.atom(chars);  }
  function peg$f22(head, tail) {
    return options.termFactory.atom(head + tail.join(''));
  }
  function peg$f23(chars) {    return options.termFactory.atom('"' + chars + '"');  }
  function peg$f24(varName) {    return options.termFactory.atom(varName);  }
  function peg$f25(val) {    return parseFloat(val);  }
  ...
  function peg$parseHyphenatedAtom() {
    let s0, s1, s2, s3, s4, s5, s6, s7;
