...
describe('Context-Dependent Type Operations', () => {
  ...
  describe('get-type', () => {
    ...
    test('should handle function types', () => {
      interpreter.space.add(
        exp(sym(':'), [sym('add'), exp(sym('->'), [sym('Number'), sym('Number'), sym('Number')])])
      );
  ...
  describe('assert-type', () => {
    test('should pass through atom when type matches', () => {
      ...
      const result = interpreter.ground.execute('&assert-type', sym('x'), sym('Number'));
    ...
    test('should return TypeError when type does not match', () => {
      ...
      const result = interpreter.ground.execute('&assert-type', sym('x'), sym('String'));
    ...
    test('should pass through when no type information exists', () => {
      const result = interpreter.ground.execute('&assert-type', sym('unknown'), sym('Number'));
    ...
    test('should handle type variables in expected type', () => {
      ...
      const result = interpreter.ground.execute('&assert-type', sym('x'), v('T'));
    ...
    test('should handle function types', () => {
      ...
      const result = interpreter.ground.execute('&assert-type', sym('add'), funcType);
    ...
    test('should detect function type mismatch', () => {
      ...
      const result = interpreter.ground.execute('&assert-type', sym('fn'), funcType2);
