...
MeTTa (Meta Type Talk) is a multi-paradigm, reflective programming language designed for Artificial General
Intelligence. It operates on a dynamic **Atomspace** metagraph, enabling pattern-matching queries, rewriting, and
self-modifying code at runtime.
