// Core re-exports — generic types (only those not conflicting with agent's own exports)
export type {
  CognitiveEvent, CognitiveEventBase, EngineOrigin,
  Connection, ConnectionState, ConnectionConfig, ConnectionDeps, TransportDeps, IOMessage,
  AgentCapabilities,
  ChatContext, ChatServiceDeps,
  Session,
  CognitiveEventSource,
} from '@senars/core';
export {
  isNarEvent, isMettaEvent, isEventType,
  ConnectionError,
  createChatService,
  NarConceptNode, MettaAtomNode, MettaSkillNode,
  SessionOrchestrator,
  KnowledgeManager,
...
export { ApprovalManager } from '../tools/adapters/external-tools.js';
export type {
  ApprovalRequest,
  ApprovalResult,
} from '../tools/adapters/external-tools.js';
