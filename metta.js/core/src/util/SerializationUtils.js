...
export class Serializable {
   ...
   */
  static async standardDeserialize(
    data,
    deserializer,
...
export function universalSerialize(obj, options = {}) {
  const { includeType = true, version = '1.0.0', customSerializers = {} } = options;
  ...
  return includeType
    ? Serializable.serializeWithVersion({ ...serialized, __type: objType }, version)
...
export async function universalDeserialize(data, options = {}) {
  const { typeMap = {}, customDeserializers = {} } = options;
