...
function peg$parse(input, options) {
  ...
  function peg$f12(operator, components) {
    return options.termFactory.create(operator.symbol, components || []);
  }
  ...
  function peg$f18(components) {    return options.termFactory.setExt(components || []);  }
  function peg$f19(components) {    return options.termFactory.setInt(components || []);  }
