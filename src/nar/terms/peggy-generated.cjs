...
function peg$parse(input, options) {
  ...
  function peg$f22(chars) {    return options.termFactory.atom('"' + chars + '"');  }
  function peg$f23(varName) {    return options.termFactory.atom(varName);  }
