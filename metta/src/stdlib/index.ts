...
const letOp = defineOp('let', (_name: MeTTaAtom, _value: MeTTaAtom, body: MeTTaAtom) => body, {
  pure: false,
});
const matchOp = defineOp('match', (_pattern: MeTTaAtom, _target: MeTTaAtom) => sym('True'), {
  pure: false,
});
