...
const KNOWN_ENV_VARS = new Set([
    ...
    'SENARS_MCP_ENABLED', 'SENARS_MCP_TRANSPORT',
    'SENARS_IRC_ENABLED', 'SENARS_IRC_SERVER', 'SENARS_IRC_PORT',
    'SENARS_IRC_NICK', 'SENARS_IRC_CHANNELS', 'SENARS_IRC_AUTH_SECRET',
    'SENARS_WS_ENABLED', 'SENARS_WS_PORT',
    'SENARS_HTTP_ENABLED', 'SENARS_HTTP_PORT',
    'SENARS_HISTFILE', 'SENARS_CONFIG', 'SENARS_CLI_ENABLED',
    'SENARS_LM_ENABLED', 'SENARS_LM_PROVIDER', 'SENARS_LM_MODEL',
    'SENARS_SENARS_ENABLED', 'SENARS_REASONING_AUTO_TRIGGER', 'SENARS_REASONING_TRIGGER_THRESHOLD',
    'SENARS_STREAMING_ENABLED', 'SENARS_TUI_COLORS', 'SENARS_TUI_TYPING_INDICATOR',
    'SENARS_MAX_SNAPSHOTS',
    'DEBUG', 'NODE_ENV', 'NODE_NO_WARNINGS', 'NODE_OPTIONS',
]);

const NUMERIC_ENV_VARS: Record<string, (v: string) => number> = {
    'EPISODIC_RETENTION_DAYS': v => parseInt(v, 10),
    'REASONING_THRESHOLD': v => parseFloat(v),
    'REASONING_COOLDOWN': v => parseInt(v, 10),
    'MAX_REASONING_STEPS': v => parseInt(v, 10),
    'SENARS_IRC_PORT': v => parseInt(v, 10),
    'SENARS_WS_PORT': v => parseInt(v, 10),
    'SENARS_HTTP_PORT': v => parseInt(v, 10),
    'SENARS_REASONING_TRIGGER_THRESHOLD': v => parseFloat(v),
    'SENARS_MAX_SNAPSHOTS': v => parseInt(v, 10),
};

const BOOLEAN_ENV_VARS = new Set([
    'AUTO_TRIGGER_REASONING', 'SENARS_AUTONOMY_BROADCAST',
    'SENARS_MCP_ENABLED', 'SENARS_IRC_ENABLED', 'SENARS_WS_ENABLED', 'SENARS_HTTP_ENABLED',
    'SENARS_LM_ENABLED', 'SENARS_SENARS_ENABLED', 'SENARS_REASONING_AUTO_TRIGGER',
    'SENARS_STREAMING_ENABLED', 'SENARS_TUI_COLORS', 'SENARS_TUI_TYPING_INDICATOR',
]);
