...
describe('LM System', () => {
  ...
  describe('Provider Management', () => {
    ...
    test('selection', () => expect(lm.selectOptimalModel({ type: 'test' })).toBe('test-provider'));
  });
  ...
  describe('Generation & Processing', () => {
    ...
    test('process & translate', async () => {
      ...
      expect(lm.translateToNarsese('cat is a mammal')).toEqual(
        expect.stringMatching(/cat.*-->.*mammal/)
      );
